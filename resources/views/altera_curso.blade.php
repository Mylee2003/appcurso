      ...
      <div class="row align-items-center">
        <div class="col-md-6">
          <div class="title d-flex align-items-center flex-wrap">
            <h2 class="mr-40">Alterar o curso</h2>
          </div>
        </div>
            ...
            <div class="col-10 ">
              <div class="invoice-card card-style mb-30">
                <div class="card-style mb-30 ">
                  <h6 class="mb-25 fs-4" >Digite o curso que deseja alterar.</h6>
                  <div class="input-style-1 fs-4 ">

                    <form action="{{route('alterar-banco-curso',$registrosCurso->id)}}" method="post">
                      @method('put')
                      @csrf
